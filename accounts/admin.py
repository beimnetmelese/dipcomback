...
class UserAdmin(DjangoUserAdmin):
	model = User
	list_display = ('email', 'display_name', 'phone_number', 'role', 'seller_status', 'is_staff', 'is_active')
	...
	fieldsets = (
		...
		('Identity', {'fields': ('email', 'display_name', 'business_name', 'phone_number')}),
	...
	add_fieldsets = (
		(None, {
			'classes': ('wide',),
			'fields': ('email', 'username', 'display_name', 'business_name', 'phone_number', 'role', 'seller_status', 'password1', 'password2'),
		}),
	)
